...
public class NumericUpDown : Stepper, ITextStyle, IFontElement
{
    ...
    public static readonly BindableProperty ButtonForegroundColorProperty = BindableProperty.Create(nameof(ButtonForegroundColor), typeof(Color), typeof(NumericUpDown), Colors.White);
    ...
    public static readonly BindableProperty ButtonBackgroundColorProperty = BindableProperty.Create(nameof(ButtonBackgroundColor), typeof(Color), typeof(NumericUpDown), Colors.Gray);
    ...
    public static readonly BindableProperty UnderlineColorProperty = BindableProperty.Create(nameof(UnderlineColor), typeof(Color), typeof(NumericUpDown), Colors.Gray);
