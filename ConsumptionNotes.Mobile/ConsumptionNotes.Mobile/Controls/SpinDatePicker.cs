...
namespace ConsumptionNotes.Mobile.Controls;

public class SpinDatePicker : View, ITextStyle, IFontElement
{
    ...
    public static readonly BindableProperty IsDayVisibleProperty = BindableProperty.Create(nameof(IsDayVisible), typeof(bool), typeof(SpinDatePicker), true);
    ...
    public static readonly BindableProperty SelectedDateProperty = BindableProperty.Create(nameof(SelectedDate), typeof(DateOnly), typeof(SpinDatePicker), DateOnly.FromDateTime(DateTime.Now), BindingMode.TwoWay);
    ...
    public static readonly BindableProperty UnderlineColorProperty = BindableProperty.Create(nameof(UnderlineColor), typeof(Color), typeof(SpinDatePicker), Colors.Gray);
